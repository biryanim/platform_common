...
//go:generate minimock -i github.com/biryanim/platform_common/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/biryanim/platform_common/pkg/db"
